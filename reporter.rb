...
fields.push({'name' => 'Authors', 'value' => 'Agris'})
...
payload = {
    'content' => 'Agris Bolsteins',
    'embeds' => embed
}.to_json

response = API.post('https://discordapp.com/api/webhooks/459005793627406359/-6FGK6la-XlTO_UZ2G62Cx-TZ0AwmMqIPd3rBkusV1nwPQo1RlmhAp3Kaxn_gHS85Aqs',
